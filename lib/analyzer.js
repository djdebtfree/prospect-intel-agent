...
async function analyze(scraped) {
  ...
  var prompt = 'You are a business intelligence analyst. Analyze this prospect and return a JSON object.\n\n' +
    ...
    '  "pipelineLite": {"phases":[{"title":"string","desc":"string"}, ...3],"projections":[{"label":"string","value":"string"}, ...3],"capabilities":[{"title":"string","desc":"string"}, ...4],"kpis":[{"label":"string","value":"string"}, ...4]},\n' +
    '  "dataDriver": {\n' +
    '    "integrationDiscovery": {"ghlDetected":true/false,"existingTools":["string",...],"migrationRequired":"0-100%","summary":"string"},\n' +
    '    "capabilities": [{"title":"string","desc":"string"}, ...4],\n' +
    '    "growthProjections": [{"label":"string","value":"string"}, ...6-9],\n' +
    '    "integrationPath": [{"component":"string","currentState":"string","action":"string","effort":"Low/Medium/High"}, ...5-7]\n' +
    '  },\n' +
